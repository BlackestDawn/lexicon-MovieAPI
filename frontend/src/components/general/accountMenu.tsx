...
export function AccountMenu() {
  ...
  if (!user) {
    return (
      <div ref={menuRef}>
        <button onClick={toggle} className="font-medium hover:text-primary hover:underline">
          Login
        </button>
  ...
  return (
    <div ref={menuRef} className="relative inline-block">
      <button
        onClick={toggle}
        className="inline-flex items-center justify-center p-2 rounded-lg text-foreground hover:bg-background focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary transition-colors duration-200"
      >
        {user.name}
      </button>
          ...
          <ul className="divide-y divide-border">
            ...
            <li>
              <button
                ...
                disabled={isPending}
                className="block w-full whitespace-nowrap px-4 py-3 text-center font-medium text-foreground hover:bg-background transition-colors duration-200 disabled:opacity-50"
              >
